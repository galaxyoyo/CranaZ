...
public class EnhancedZombie extends EntityZombie{
	...
	public static final double SPEED = 0.23000000417232513D * 1.6D, FOLLOW_RANGE = 60D, MOVE_SPEED = SPEED * 1.75D;
	...
	protected void aC() {
		...
		int tmp = this.random.nextInt(15), tmpHealth;
		if(tmp < 10)
			tmpHealth = 12;
		else
			tmpHealth = tmp;
		this.getAttributeInstance(GenericAttributes.e).setValue(Integer.valueOf(tmpHealth).doubleValue());
	}
	@Override
