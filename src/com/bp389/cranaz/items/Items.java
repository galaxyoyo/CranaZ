...
public final class Items {
	...
	public static ItemStack customFence() {
		return Items.getLoredItem(Material.FENCE, "Barricade", "Pour se protéger en toutes circonstances !");
	}
		...
		public static enum Poison {
			...
			private static ItemStack arterial() {
				return Items.getLoredItem(Material.PUMPKIN_PIE, "Poison arteriel", "Augmente la pression sanguine de la cible.",
				        "Cause des dommages directs moyens", "Fait effet après 45 secondes.");
			}
			...
			private static ItemStack neurotoxic() {
				return Items.getLoredItem(Material.PUMPKIN_PIE, "Poison neurotoxique", "Affaiblit fortement le joueur cible.",
				        "Ne cause AUCUN dommage direct.", "Fait effet 2 minutes après injection.");
			}
		}
	}
	...
	public static class Diaries {
		...
		public enum Utils implements DiaryEnum {
			RULES("Règles", "Staff de CranaZ", Utils.getRules()), STAFF("Membres du staff", "Staff de CranaZ", Arrays.asList("Membres du staff de CranaZ:\n\n"
			        ...
			        .asList("Dans un monde impitoyable," + " il est important de savoir comment créer soi-même ce dont l'on a besoin."
			                + " Je suis sûr que vous connaissez déjà beaucoup de choses, mais dans ce monde," + " beaucoup de choses sont uniques.",
			                "Vous trouverez sur les pages suivantes" + " une liste(à peu près exhaustive)des plans de fabrication" + " de divers objets.",
		...
		public enum Bedroom implements DiaryEnum {
			JORDAN_KENS("Journal de Jordan - Chapitre 1", "Jordan Kens", Arrays.asList("08/07/2014\n\n" + "Une nouvelle maladie semble prendre forme.\n"
			        ...
			        + "et des balles. Nous ésperons ne pas avoir à nous en servir.", "20/11/2014\n\n"
			        ...
			        + "mais mon père avait prévu le coup. J'espère que nous aurons de quoi manger.", "12/02/2015\n\n" + "Beaucoup d'humains sont infectés.\n"
			        + "Nous allons démenager sur une île où nous serons tranquilles pendant que\n" + "ces saloperies pourrissent.", "20/05/2017\n\n"
			        + "Je viens d'avoir 16 ans, et je vais apprendre à tirer." + "J'aurai dû prendre mon arc, mais je l'ai laissé dans notre ancienne maison."
			        + "Les cadavres de zombies s'empilent devant la maison. J'en ai la nausée.", "18/07/2020\n\n"
			        + "Ils travaillent sur un antidote, j'èspère qu'ils y arriveront.", "22/01/2022\n\n"
